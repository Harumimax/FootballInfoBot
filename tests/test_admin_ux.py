...
class AdminUxTest(unittest.TestCase):
    ...
    def test_admin_league_keyboards_use_mvp_leagues(self) -> None:
        ...
        self.assertEqual(sync_keyboard.inline_keyboard[0][0].callback_data, f"{CALLBACK_ADMIN_SYNC_PREFIX}league")
        self.assertEqual(sync_keyboard.inline_keyboard[1][0].callback_data, f"{CALLBACK_ADMIN_SYNC_PREFIX}uefa_cup")
        self.assertEqual(sync_keyboard.inline_keyboard[2][0].callback_data, f"{CALLBACK_ADMIN_SYNC_PREFIX}lc")
        self.assertEqual(sync_keyboard.inline_keyboard[3][0].callback_data, f"{CALLBACK_ADMIN_SYNC_PREFIX}england")
        self.assertEqual(sync_keyboard.inline_keyboard[8][0].callback_data, f"{CALLBACK_ADMIN_SYNC_PREFIX}ruschamp")
        self.assertEqual(toggle_keyboard.inline_keyboard[0][0].callback_data, f"{CALLBACK_ADMIN_TOGGLE_PREFIX}league")
        self.assertEqual(toggle_keyboard.inline_keyboard[1][0].callback_data, f"{CALLBACK_ADMIN_TOGGLE_PREFIX}uefa_cup")
        self.assertEqual(toggle_keyboard.inline_keyboard[2][0].callback_data, f"{CALLBACK_ADMIN_TOGGLE_PREFIX}lc")
        self.assertEqual(toggle_keyboard.inline_keyboard[3][0].callback_data, f"{CALLBACK_ADMIN_TOGGLE_PREFIX}england")
        self.assertEqual(toggle_keyboard.inline_keyboard[8][0].callback_data, f"{CALLBACK_ADMIN_TOGGLE_PREFIX}ruschamp")
        self.assertEqual(teams_keyboard.inline_keyboard[0][0].callback_data, f"{CALLBACK_ADMIN_TEAMS_PREFIX}league")
        self.assertEqual(teams_keyboard.inline_keyboard[1][0].callback_data, f"{CALLBACK_ADMIN_TEAMS_PREFIX}uefa_cup")
        self.assertEqual(teams_keyboard.inline_keyboard[2][0].callback_data, f"{CALLBACK_ADMIN_TEAMS_PREFIX}lc")
        self.assertEqual(teams_keyboard.inline_keyboard[3][0].callback_data, f"{CALLBACK_ADMIN_TEAMS_PREFIX}england")
        self.assertEqual(teams_keyboard.inline_keyboard[8][0].callback_data, f"{CALLBACK_ADMIN_TEAMS_PREFIX}ruschamp")
    ...
    def test_parser_status_defaults_to_mvp_leagues(self) -> None:
        ...
        self.assertIn("Лига чемпионов: последнее успешное обновление нет данных, включена", message)
        self.assertIn("Лига Европы: последнее успешное обновление нет данных, включена", message)
        self.assertIn("Лига конференций: последнее успешное обновление нет данных, включена", message)
    ...
    def test_league_name_by_code_falls_back_to_code(self) -> None:
        ...
        self.assertEqual(league_name_by_code("league"), "Лига чемпионов")
        self.assertEqual(league_name_by_code("uefa_cup"), "Лига Европы")
        self.assertEqual(league_name_by_code("lc"), "Лига конференций")
